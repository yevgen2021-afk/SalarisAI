...
const Sidebar = ({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-[100] w-[70vw] md:w-72 rounded-r-[1.5rem] overflow-hidden shadow-[0_16px_40px_rgba(0,0,0,0.2)] border-r flex flex-col transform transition-transform duration-300 ease-in-out will-change-transform ${
